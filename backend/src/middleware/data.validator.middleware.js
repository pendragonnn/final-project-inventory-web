const { 
  ...
  const transactionHeaderValidator = (req, res, next) => {
    ...
    if (error) {
      ...
      return res
        .status(400)
        .json({ status: "fail", message: `add transaction failed, ${errorMessage}` });
    }
  ...
  const supplierValidator = (req, res, next) => {
    ...
    if (error) {
      ...
      return res
        .status(400)
        .json({ status: "fail", message: `add supplier failed, ${errorMessage}` });
    }
  ...
  const categoryValidator = (req, res, next) => {
    ...
    if (error) {
      ...
      return res
        .status(400)
        .json({ status: "fail", message: `add category failed, ${errorMessage}` });
    }
