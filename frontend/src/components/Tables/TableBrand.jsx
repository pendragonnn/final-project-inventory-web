...
import ModalEditBrand from "../Modal/Brand/ModalEditBrand";
import Loader from "../common/Loader";
import ModalBrandAdd from "../Modal/brand/ModalAddBrand";
import ModalImageBrand from "../Modal/brand/ModalImageBrand";
...
const TableBrand = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				const res = await Brand.getBrand(currentPage, size);
	...
	const handleEditData = async (updatedBrand) => {
		setData((prevData) =>
			prevData.map((brand) =>
	...
	return (
		<div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
			...
			{isModalOpen && (
				<ModalImageBrand imageUrl={imageModal} closeModal={closeModal} />
			)}
		</div>
	);
};
