								...
								{isDataEmpty ? (
									...
									filteredData.map((value, idx) => (
										<tr key={idx} className="border-b dark:border-strokedark">
											...
											<td className="py-4 font-medium px-6 text-center">
												{value?.TransactionDetails[0].item_id}
											</td>
											<td className="py-4 font-medium px-6 text-center">
												{value?.TransactionDetails[0].quantity}
											</td>
											{user !== "2" && (
												// <>
												<td className="py-4 px-6 text-center">
													<div className="flex justify-center items-center space-x-3">
														<button
															...
															onClick={() =>
																router.push(`/reports/issuing/${value.id}`)
															}
														>
															<svg
																xmlns="http://www.w3.org/2000/svg"
...
export default TableReportIssuing;
