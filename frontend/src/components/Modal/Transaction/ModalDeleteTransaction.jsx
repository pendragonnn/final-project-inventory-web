	...
	return (
		<>
			...
			<div className="modal" role="dialog">
				<div className="modal-box text-center bg-white dark:bg-meta-4">
					...
					<div className="modal-action flex justify-center ">
						<label
							htmlFor={open}
							className="btn px-10 hover:bg-danger border-white dark:border-meta-4 bg-meta-1 text-white"
						...
						<label
							htmlFor={open}
							className="btn px-10 hover:bg-body border-white dark:border-meta-4 bg-bodydark2 text-white"
						>
							No
						</label>
					</div>
