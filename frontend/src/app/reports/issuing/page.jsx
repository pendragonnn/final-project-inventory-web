...
import TableReportIssuing from "@/components/Tables/TableReportIssuing";
...
const ReportIssuing = () => {
	...
	useEffect(() => {
		const fetchData = async () => {
			...
			try {
				const res = await getTransactionHeaderIssuing(currentPage, size);
				setData(res.data);
	...
	if (user) {
		return (
			<SidebarLayout>
				<Breadcrumb pageName="Report Issuing" />
				<TableReportIssuing
					reportType="Issuing"
