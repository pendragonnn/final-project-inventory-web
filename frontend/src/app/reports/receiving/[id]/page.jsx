...
const DetailReportReceiving = () => {
	...
	const handleExportPDF = () => {
		...
		doc.setFontSize(16);
		const text = "REPORT RECEIVING DETAIL";
		...
		doc.text(`Supplier: ${data.Supplier.name}`, margin, yPosition + 8);
		yPosition;
		...
		doc.save("report_receiving_detail.pdf");
	};
						...
						<div className="bg-white dark:bg-boxdark rounded-lg shadow-md">
							<div className="flex flex-row items-center justify-between p-6">
								<h1 className="text-2xl font-bold text-gray-900 dark:text-white">
									Report Receiving Detail :&nbsp;{data.id}
								</h1>
